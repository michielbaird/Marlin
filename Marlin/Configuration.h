 ...
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 100, 100, 1600, 133 }
...
#define X_MIN_POS -7.80
#define Y_MIN_POS -16.70
#define Z_MIN_POS 0
...
#define MIN_PROBE_X (8.60 + X_PROBE_OFFSET_FROM_EXTRUDER)
#define MAX_PROBE_X (209.80 + X_PROBE_OFFSET_FROM_EXTRUDER)
#define MIN_PROBE_Y (2.40 + Y_PROBE_OFFSET_FROM_EXTRUDER)
#define MAX_PROBE_Y (201.30 + Y_PROBE_OFFSET_FROM_EXTRUDER)
...
// #define MIN_PROBE_Y -8
#if ENABLED(Z_SAFE_HOMING)

  #define Z_SAFE_HOMING_X_POINT 42.60     // X point for Z homing when homing all axes (G28).
  #define Z_SAFE_HOMING_Y_POINT 17.50   // Y point for Z homing when homing all axes (G28).
#endif
